...
VALUES ('test@test.test', 'testpass');


CREATE TABLE IF NOT EXISTS `itd105app`.`globaltemps` (id INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
`date` date, 
`LandAverageTemperature` varchar(22), 
`LandAverageTemperatureUncertainty` varchar(33), 
`LandMaxTemperature` varchar(18), 
`LandMaxTemperatureUncertainty` varchar(29), 
`LandMinTemperature` varchar(21), 
`LandMinTemperatureUncertainty` varchar(29), 
`LandAndOceanAverageTemperature` varchar(30), 
`LandAndOceanAverageTemperatureUncertainty` varchar(41));

DESC globaltemps;

INSERT INTO `itd105app`.`globaltemps` (date, LandAverageTemperature, LandAverageTemperatureUncertainty, LandMaxTemperature, LandMaxTemperatureUncertainty, LandMinTemperature, LandMinTemperatureUncertainty, LandAndOceanAverageTemperature, LandAndOceanAverageTemperatureUncertainty) VALUES 
